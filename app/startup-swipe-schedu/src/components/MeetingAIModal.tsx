...
import { Sparkle, Share, Copy } from '@phosphor-icons/react'
...
export function MeetingAIModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="!flex !flex-col !h-screen md:!h-[90vh] !w-full md:!max-w-4xl !rounded-none md:!rounded-lg !border-0 md:!border !p-0 md:!p-4 overflow-hidden !fixed !inset-0 md:!inset-auto md:!top-1/2 md:!left-1/2 md:!-translate-x-1/2 md:!-translate-y-1/2">
        {/* Header */}
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <h2 className="font-semibold text-sm md:text-base truncate">Meeting Prep: {startupName}</h2>
            ...
            <div className="flex gap-1 md:gap-2 flex-shrink-0">
              <Button
                ...
                className="h-8 w-8 md:h-9 md:w-auto md:px-2"
                title="Copy to clipboard"
              >
                <Copy size={16} className="md:mr-1" />
              ...
              >
                <Share size={16} className="md:mr-1" />
